...
namespace Tebak_Kata
{
    class Program
    {
        ...
        static string kataMisteri = "Evos";
        ...
        static void Main(string[] args)
        {
           ...
           static void Intro()
           {
                ...
                Console.WriteLine("Selamat datng pada hari ini kita akan bermain tebak kata");
                ...
                Console.WriteLine("Jawaban dari kata misteri Adalah tim esport di Indonesia yang punya M1");
